...
export default function Sidenav(props) {
  ...
  return (
    <>
      <div className="so PHIDE" onClick={toggle}>
        OPEN
      </div>
      <aside
        className="bg-white shadow-sm -translate-x-80 fixed inset-0 z-50 my-4 ml-4 h-[calc(100vh-32px)] w-72 rounded-xl transition-transform duration-300 xl:translate-x-0 border border-blue-gray-100 PHIDE"
        id="sn"
        onClick={toggle}
